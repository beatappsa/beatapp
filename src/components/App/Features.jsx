    ...
    <section className="features pt-70 pb-70 style-4" data-scroll-index="1">
      <div className="container">
        <div className="section-head text-center style-4">
          <small className="title_small bg-white">{ rtl ? 'نظام واحد... يعمل بدلاً منك' : 'One system... works for you' }</small>
          <h2 className="mb-70">{ rtl ? 'ماذا سيتغير' : 'What will change' } <span> { rtl ? 'بعد تعاونك معنا؟' : 'after you work with us?' } </span> </h2>
        </div>
