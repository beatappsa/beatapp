      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-[#EBF5FB] rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-[#5546FB]" fill="currentColor" viewBox="0 0 20 20">
            ...
            {/* Personal Brands and Independent Marketers */}
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-[#EBF5FB] rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-[#5546FB]" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3z" />
            ...
            {/* Course Providers and Consultants */}
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-[#EBF5FB] rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-[#5546FB]" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-4 font-sans">
                "BeatApp سهّل علينا متابعة أولياء الأمور والطلاب بشكل منظم وسريع."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-gray-300 rounded-full mr-4"></div>
                <div>
                  <h4 className="font-semibold text-gray-900 font-sans">أحمد الحربي</h4>
                  <p className="text-gray-600 text-sm font-sans">مديرة مدرسة أهلية</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-4 font-sans">
                "BeatApp أنقذنا من الفوضى، وكل تفاعل الآن محسوب."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-gray-300 rounded-full mr-4"></div>
                <div>
                  <h4 className="font-semibold text-gray-900 font-sans">فاطمة العبدالله</h4>
                  <p className="text-gray-600 text-sm font-sans">صاحب مركز تدريبي</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-4 font-sans">
                "كنا نتواصل مع العملاء يدوياً، الآن كل شيء مؤتمت… وزادت التحويلات."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-gray-300 rounded-full mr-4"></div>
                <div>
                  <h4 className="font-semibold text-gray-900 font-sans">نجلاء القحطاني</h4>
                  <p className="text-gray-600 text-sm font-sans">عيادة تجميل</p>
                </div>
              </div>
            </div>
          </div>
