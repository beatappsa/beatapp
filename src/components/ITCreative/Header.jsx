              ...
              <div className="col-lg-6">
                <div className="info mt-5 mt-lg-0">
                  ...
                  <h1 className="hero-title arabic-text">
                    🚀 هل تريد <span className="text-grad"> مضاعفة عملائك </span><br />
                    <span className="num"> دون إضاعة وقتك </span><br />
                    في التسويق؟
                  </h1>
                  <div className="mb-4">
                    <p className="text-xl leading-relaxed arabic-text">
                      <strong>BeatApp</strong> يجمع لك كل خطوات جذب العميل ومتابعته وتحويله في نظام واحد يشتغل عنك حتى وأنت مشغول.
                    </p>
                  </div>
                  <div className="d-flex flex-wrap">
                    ...
                    <div className="inf mt-3 mt-lg-0">
                      <p className="color-999"> للتواصل </p>
                      <a href="tel:0500934900" className="fw-bold"> 📞 0500934900 </a>
                    </div>
                  </div>
                </div>
              </div>
