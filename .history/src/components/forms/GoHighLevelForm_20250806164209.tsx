  ...
  return (
    <form onSubmit={handleSubmit} className={`space-y-6 ${className}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label htmlFor="firstName" className="block text-sm font-semibold text-gray-700 mb-2 font-sans">
            الاسم الأول *
          </label>
          <input
            type="text"
          ...
          />
          {errors.firstName && (
            <p className="mt-1 text-sm text-red-600 font-sans">{errors.firstName}</p>
          )}
        </div>
        
        <div>
          <label htmlFor="lastName" className="block text-sm font-semibold text-gray-700 mb-2 font-sans">
            اسم العائلة *
          </label>
          <input
            type="text"
          ...
          />
          {errors.lastName && (
            <p className="mt-1 text-sm text-red-600 font-sans">{errors.lastName}</p>
          )}
        </div>
      </div>
      ...
      <div>
        ...
        <input
          ...
          onChange={handleInputChange}
          className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#5546FB] focus:border-[#5546FB] transition-colors font-sans text-right"
      ...
      <div>
        ...
        <textarea
          ...
          onChange={handleInputChange}
          rows={4}
          className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#5546FB] focus:border-[#5546FB] transition-colors font-sans text-right resize-none"
          placeholder="أخبرنا عن احتياجاتك أو أي تفاصيل إضافية..."
          dir="rtl"
        />
      </div>
