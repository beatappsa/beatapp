          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="text-right">
                ...
                <p className="text-gray-600 leading-relaxed font-sans mt-2">
                    ...
                    <div className="p-6">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          <span className="text-sm font-medium">CRM & PIPELINE MANAGEMENT</span>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center">
                            ...
                            <span className="text-sm">Calendars and Booking</span>
                          </div>
                          <div className="flex items-center">
                        ...
                        {/* Chart Area */}
                        <div className="mt-6 h-32 bg-gradient-to-r from-blue-100 to-purple-100 rounded-lg flex items-end justify-center p-4">
                          <div className="flex items-end space-x-1">
                            <div className="w-2 h-8 bg-blue-400 rounded-t"></div>
                            <div className="w-2 h-12 bg-blue-500 rounded-t"></div>
                            <div className="w-2 h-6 bg-blue-400 rounded-t"></div>
                            <div className="w-2 h-16 bg-blue-600 rounded-t"></div>
